            ...
            <div className="col-md-4">
              <div className="testimonial-boxs">
                <p>
                  ...
                  can slather it on as much as I want without any irritation, it
                  soaks right in and soothes my skin. I'm a lifetime customer
                  for sure. Being a non-oily product, it leaves no room for acne
                  which is a major cause of concern for many.
                  <i
            ...
            <div className="col-md-4">
              <div className="testimonial-boxs">
                <p>
                  ...
                  totally satisfied with the results. The best part is that the
                  sunscreen is non-greasy.
                  <i
                    className="fa fa-quote-right"
                    style={{ paddingRight: 25 }}
                  />
